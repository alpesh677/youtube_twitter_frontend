...
export const editTweet = createAsyncThunk("editTweet",
...
export const deleteTweet = createAsyncThunk("deleteTweet",
    async ({tweetId}) =>{
        try {
            const response = await axiosInstance(`/tweet/${tweetId}`);
            toast.success(response.data.message);
...
export const getUserTweets = createAsyncThunk("getUserTweets",
    async({userId}) =>{
        try {
